...
| :-------------- | :-------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Python 3.11** | Язык разработки                                                                                                       | Современный, быстрый, с отличной поддержкой асинхронности, идеален для I/O-bound задач, таких как работа с API.                                                                                                |
...
- [ ] Добавление поддержки нескольких провайдеров LLM (Groq, Anthropic).
